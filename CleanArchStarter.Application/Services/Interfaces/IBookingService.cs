...
public interface IBookingService
{
    ...
    Task<Result<IEnumerable<BookingResponse>>> GetMyCancelledBookingsAsync(string userId, CancellationToken cancellationToken = default);
    ...
    Task<Result<IEnumerable<BookingResponse>>> GetCancellationRequestsAsync(string userId, CancellationToken cancellationToken = default);
